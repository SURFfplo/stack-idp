...
$config = array(
    ...
    */
	...
	'attributes' => array(
        ...
        //'dnpattern' => 'uid=%username%,ou=people,dc=surfuni,dc=org',
        'dnpattern' => 'mail=%username%,%SSP_LDAP_DOMAIN%',
    ...
    */
    ...
    'SURFconext' => array(
        ...
        'description' => array(
                'en' => 'A modulair digital learning environment.',
        ),
		...
		'urn:mace:dir:attribute-def:sn', // surname
                ...
                'urn:mace:terena.org:attribute-def:schacHomeOrganization', // organization
                'urn:mace:dir:attribute-def:eduPersonAffiliation', // affiliation
                'urn:mace:dir:attribute-def:eduPersonTargetedID', // name-id
        ),
	...
	// add uid attribute from ldap
		...
		50 => array(
    		...
    		60 => array(
        		...
        		'urn:mace:dir:attribute-def:mail' => 'cn',
        		'urn:mace:dir:attribute-def:mail' => 'mail',
...
'ldapandsurf' => array(
     ...
     */
    'sources' => array('surfuni-ldap', 'SURFconext'),
),
